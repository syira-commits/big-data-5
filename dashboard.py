...
@st.cache_resource
def load_models():
    yolo_model = YOLO("model/Mulya_Syira_Laporan4.pt")  # Model deteksi objek
    classifier = tf.keras.models.load_model("model/Mulya_Syira_Laporan2.h5")  # Model klasifikasi
